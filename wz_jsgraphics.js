...
function _htmRpc()
{
	return this.htm.replace(
		_regex,
		'<div class="transbox" style="overflow:hidden;position:absolute;background-color:' +
...
interior_extrema. */
	...
	{
	    this.htm += '<div class="transbox" style="position:absolute;white-space:nowrap;' +
			'left:' + x + 'px;'+
			'top:' + y + 'px;'+
...
text both horizontally (e.g. right) and vertically within that rectangle */
	...
	{
	    this.htm += '<div class="transbox" style="position:absolute;overflow:hidden;' +
			'left:' + x + 'px;'+
			'top:' + y + 'px;'+
			'width:'+width +'px;'+
			'text-align:'+halign+';'+
